...
def generate_gemini_sketch(image_bgr: np.ndarray, api_key: str = None, prompt: str = None, character_image_bgr: np.ndarray = None) -> np.ndarray:
    """
    ...
    try:
        ...
        if character_image_bgr is not None:
            ...
            if success_char:
                ...
                print("[경고] 캐릭터 이미지 인코딩 실패, 메인 이미지만 사용합니다.")
